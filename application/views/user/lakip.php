...
//renstra
$querytampil = "SELECT * FROM renstra ORDER by id DESC LIMIT $jumlahDataPerHalaman";
$renstra = $this->db->query($querytampil)->result_array();
        ...
        <div class="container">
            <div class="row">
                <div class="baca">
                    ...
                    <h2>Lakip Renstra Kecamatan Socah</h2>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <div class="exp-block2">
                            <h3><i class="icon-documents"></i>Lakip</h3>
                            <ul class="list-none larens">
                            <?php foreach ($lakip as $l) : ?>
                                <li> 
                                    <a href="<?= base_url('assets/dokumen/lakip/') . $l['lakip']; ?>" type="application/pdf" width="100%" height="100%">
                                    <h4><?php echo substr($l["judul"], 0, 50); ?></h4>  
                                    </a>
                    ...
                    <div class="col-xs-12 col-sm-6">
                        <div class="exp-block2">
                            <h3> <i class="icon-book-open"></i>Renstra</h3>
                            <ul class="list-none larens">
                            <?php foreach ($renstra as $r) : ?>
                                <li> 
                                    <a href="<?= base_url('assets/dokumen/renstra/') . $r['renstra']; ?>" type="application/pdf" width="100%" height="100%">
                                    <h4><?php echo substr($r["judul"], 0, 50); ?></h4>  
                                    </a>
