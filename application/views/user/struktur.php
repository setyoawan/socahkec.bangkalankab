        ...
        <div class="container">
            <div class="row">
                <div class="baca">
                    ...
                    <h2>Struktur Organisasi Socah</h2>
                    <br>
                    <br>
                    <?php foreach ($struktur as $s) : ?>
                    <div>
                            <a href="<?= base_url('assets/img/struktur/') . $s['foto']; ?>" data-fancybox="group" data-caption="<?= $s['judul']; ?>">
                                    <img style="height: 100%;width: 100%;border-radius: 7px;" src="<?= base_url('assets/img/struktur/') . $s['foto']; ?>">
                                    <div class="item-musk">
                                        <div class="item-caption">
                                            <p><?php echo substr($s["judul"], 0, 50); ?></p>
                                        </div>
                                    </div> 
                                </a>
