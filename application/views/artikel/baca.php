...
$query = "SELECT * FROM artikel WHERE id = '$id_artikel' LIMIT 1";
                ...
                <div class="col-xs-12 col-sm-8 col-md-8">
                    <div class="panel panel-default mb-4">
                        <div class="panel-heading post-thumb">
                            <img src="<?= base_url('assets/img/artikelberita/') . $row['gambar']; ?>" alt="" class="img-responsive">
                        </div>
                        <div class="panel-body post-body artikelbaru">
                            <h2><?php echo $row["judul_artikel"]; ?></h2>
                            <p align="center"><?php echo '<em>' . date('j, F Y', strtotime($row['tgl_artikel'])) . '</em>'; ?></p>
                ...
                <div class="col-xs-12 col-sm-4 col-md-4">
                    ...
                    <div class="panel panel-default shadow mb-4">
                        ...
                        <div class="panel-heading py-3">
                            <h3 class="m-0 font-weight-bold text-dark"><i class="icon-documents"></i>&nbspKegiatan Socah</h3>
                        </div>
                        <!-- Card Body -->
                        <div class="panel-body post-body">
                            <?php foreach ($user as $ar) : ?>
                                <a href="<?= base_url('kegiatan/'); ?>loadkegiatan?id=<?= $ar['id']; ?>" class="text-primary"> <i class="icon-book-open"></i> <?php echo substr($ar["judul_kegiatan"], 0, 50); ?></a>
                                </p>
                            <?php endforeach; ?>
