...
<div class="container bg-light pb-4">
        <div class="row">
            <div class="col">
            <h4>Halaman edit data kegiatan!</h4>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col">
            ...
            <input class="form-control" type="text" name="judul_kegiatan" id="judul_kegiatan" required="required" value="<?php echo $u->judul_kegiatan ?>"> 
            <br>
            
            <label for="isi_kegiatan">isi Kegiatan </label>
            <textarea class="form-control" type="text" name="isi_kegiatan" id="isi_kegiatan" style="height: 400px;"> <?php echo $u->isi_kegiatan  ?></textarea>
            <br>
