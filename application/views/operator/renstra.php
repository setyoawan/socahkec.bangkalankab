        ...
        <div class="container-fluid">
          ...
          Upload file renstra (PDF FILE)
          <hr class="sidebar-divider d-none d-md-block mt-0">
          <div class="row">
            <div class="col-lg-8">
              <?php echo $this->session->flashdata('message') ?>
              <?= form_open_multipart('operator/uploadrenstra'); ?>
                  ...
                  <div class="row">
                    <div class="col-sm-10">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" id="renstra" name="renstra">
                        <label class="custom-file-label" for="renstra">Choose file</label>
                      </div>
                    </div>
                  </div>
                </div>
