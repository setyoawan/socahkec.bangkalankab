        ...
        <div class="container-fluid">
          ...
          Upload file lakip (PDF FILE)
          <hr class="sidebar-divider d-none d-md-block mt-0">
          <div class="row">
            <div class="col-lg-8">
              <?php echo $this->session->flashdata('message') ?>
              <?= form_open_multipart('operator/uploadlakip'); ?>
                  ...
                  <div class="row">
                    <div class="col-sm-10">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" id="lakip" name="lakip">
                        <label class="custom-file-label" for="lakip">Choose file</label>
                      </div>
                    </div>
                  </div>
                </div>
